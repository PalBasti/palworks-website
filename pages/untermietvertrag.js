        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <div className="text-right">
              ...
              <p className="text-sm text-gray-600">Ganze Wohnung</p>
            </div>
          </div>
        </div>
      </header>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-lg shadow-lg p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      <div>
                        <p className="font-medium">Untermietvertrag</p>
                    ...
                    {contractData.include_protocol && (
                      <div className="flex justify-between items-center border-t pt-3">
                        ...
                        <span className="font-bold text-blue-600">4,90 €</span>
                      </div>
                    )}
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-blue-800 space-y-1">
                    <li>• Rechtssicherer Untermietvertrag als PDF</li>
