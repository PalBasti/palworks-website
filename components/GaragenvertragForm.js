// components/GaragenvertragForm.js - KORRIGIERT: Addons funktionieren wieder
import { useState, useEffect } from 'react'
import { Check, Mail, Info, FileText, CreditCard, User, Building, ArrowLeft } from 'lucide-react'
...
export default function GaragenvertragForm({ onSubmit }) {
  ...
  // ✅ FALLBACK ADDONS (damit sofort etwas angezeigt wird) - FUNKTIONIERT!
