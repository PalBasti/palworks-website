...
/**
 * Minimal Config-Approach für konsistente PDF-Formatierung
 * Einfach zu integrieren, sofortige Verbesserung der Layout-Qualität
 */
    ...
    rows.forEach(row => {
      ...
      row.forEach((cell, index) => {
        if (typeof cell === 'object' && cell.type === 'input') {
          ...
          this.pdf.rect(currentX, this.currentY - 4, widths[index] - 2, rowHeight);
        } else {
          // Text in Tabelle
