// lib/pdf/untermietvertragGenerator.js - VOLLSTÄNDIGE KORRIGIERTE VERSION
// Behebt: Blank fields, Unterschriftenzeile, bessere Formatierung + Vertragserläuterungen
...
export async function generateAndReturnPDF(formData, selectedAddons = [], returnType = 'blob') {
  ...
  try {
    ...
    // Vertragserläuterungen hinzufügen
    if (selectedAddons && Array.isArray(selectedAddons) && 
...
// Vertragserläuterungen-Funktion
